...
if (count($_POST) > 1) {
    ...
    $authorlist = array("", "migul de cervantes", "charles dickens", "j.r.r tolkien", "antoine de siant-exuper");
    ...
    for ($i = 1; $i < 5; $i++) {
        ...
        $table_rows .= "<tr><td>" . $ authorlist [$i] . " Got:</td><td><b>" . $result[0] . "</b> votes</td></tr>";
